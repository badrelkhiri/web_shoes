    ...
    >
      <div className="relative xl:w-2/5 flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-planquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 pb-3">
            The New Arrival
          </span>
          <br />
          <span className="inline-block mt-3 text-[80px] text-coral-red">Shoesy</span> Shoes
        </h1>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:max-h-[90vh] max-xl:py-40 bg-hero bg-center bgcover bg-primary">
        <img
          src={bigSheoImg}
          alt="shoe collection"
          width={610}
